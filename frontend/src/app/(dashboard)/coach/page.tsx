...
export default function CoachPage() {
    ...
    return (
        <div className="flex flex-col h-[100svh] md:h-[calc(100vh-80px)] bg-background">
            ...
            <div className="flex-shrink-0 border-t border-border/40 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/80 md:relative fixed bottom-[calc(5.5rem+env(safe-area-inset-bottom))] md:bottom-0 left-0 right-0 z-10">
